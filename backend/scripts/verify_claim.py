...
# Note: Standalone CLI dispatch is canonically handled by the native binary:
#   uv run tathvyn verify "claim here"
if __name__ == "__main__":
    import argparse

    parser = argparse.ArgumentParser(description="Tathvyn Claim Verification")
    parser.add_argument("claim", nargs="+", help="The claim text to verify.")
    args = parser.parse_args()
    asyncio.run(verify_single_claim(claim_text=" ".join(args.claim)))
